...
export namespace HealthCheck {
  ...
  export class HttpHealthCheck extends jspb.Message {
    ...
    getCodecClientType(): envoy_type_http_pb.CodecClientTypeMap[keyof envoy_type_http_pb.CodecClientTypeMap];
    setCodecClientType(value: envoy_type_http_pb.CodecClientTypeMap[keyof envoy_type_http_pb.CodecClientTypeMap]): void;
  ...
  export namespace HttpHealthCheck {
    export type AsObject = {
      ...
      codecClientType: envoy_type_http_pb.CodecClientTypeMap[keyof envoy_type_http_pb.CodecClientTypeMap],
