...
export class ApiConfigSource extends jspb.Message {
  getApiType(): ApiConfigSource.ApiTypeMap[keyof ApiConfigSource.ApiTypeMap];
  setApiType(value: ApiConfigSource.ApiTypeMap[keyof ApiConfigSource.ApiTypeMap]): void;

  getTransportApiVersion(): ApiVersionMap[keyof ApiVersionMap];
  setTransportApiVersion(value: ApiVersionMap[keyof ApiVersionMap]): void;
...
export namespace ApiConfigSource {
  export type AsObject = {
    apiType: ApiConfigSource.ApiTypeMap[keyof ApiConfigSource.ApiTypeMap],
    transportApiVersion: ApiVersionMap[keyof ApiVersionMap],
  ...
  export const ApiType: ApiTypeMap;
}
...
export class ConfigSource extends jspb.Message {
  ...
  getResourceApiVersion(): ApiVersionMap[keyof ApiVersionMap];
  setResourceApiVersion(value: ApiVersionMap[keyof ApiVersionMap]): void;
...
export namespace ConfigSource {
  export type AsObject = {
    ...
    resourceApiVersion: ApiVersionMap[keyof ApiVersionMap],
  }
