...
import * as xds_core_v3_context_params_pb from "../../../../xds/core/v3/context_params_pb";
...
export class Node extends jspb.Message {
  ...
  getDynamicParametersMap(): jspb.Map<string, xds_core_v3_context_params_pb.ContextParams>;
  clearDynamicParametersMap(): void;
  hasLocality(): boolean;
  clearLocality(): void;
...
export namespace Node {
  export type AsObject = {
    ...
    cluster: string,
    metadata?: google_protobuf_struct_pb.Struct.AsObject,
    dynamicParametersMap: Array<[string, xds_core_v3_context_params_pb.ContextParams.AsObject]>,
...
export class WatchedDirectory extends jspb.Message {
  getPath(): string;
  setPath(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): WatchedDirectory.AsObject;
  static toObject(includeInstance: boolean, msg: WatchedDirectory): WatchedDirectory.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: WatchedDirectory, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): WatchedDirectory;
  static deserializeBinaryFromReader(message: WatchedDirectory, reader: jspb.BinaryReader): WatchedDirectory;
}

export namespace WatchedDirectory {
  export type AsObject = {
    path: string,
  }
}
