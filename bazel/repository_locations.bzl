...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_envoyproxy_envoy = dict(
        project_name = "Envoy",
        project_desc = "Cloud-native high-performance edge/middle/service proxy",
        project_url = "https://github.com/envoyproxy/envoy",
        version = "1.17.1",
        sha256 = "c9bbb5d95ec02bada3780a2363c6372fc8c0c623d7646d9a714cded7306641bb",
        strip_prefix = "envoy-{version}",
        urls = ["https://github.com/envoyproxy/envoy/archive/v{version}.tar.gz"],
    ...
    io_bazel_rules_go = dict(
        ...
        project_desc = "Go rules for Bazel",
